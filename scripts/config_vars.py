...
REPORT_UI_PORT = 8012
MONGO_CONNECTION_STRING = "mongodb://localhost:27017" #"mongodb://mongo-report:8013"  #use "mongo" when mongo is running  in a container, use "localhost" if running in machine
